...
@objc class AppDelegate: FlutterAppDelegate {
  ...
  override func application(
    ...
    SiriCredentialsBridge.register(with: flutterViewController.binaryMessenger)
  ...
  // NUEVOS CAMBIOS: Variables y funciones para mantener la app viva 30 segundos en segundo plano
  var backgroundTask: UIBackgroundTaskIdentifier = .invalid

  override func applicationDidEnterBackground(_ application: UIApplication) {
    super.applicationDidEnterBackground(application)
    
    backgroundTask = application.beginBackgroundTask(withName: "VentanaMQTT") {
      application.endBackgroundTask(self.backgroundTask)
      self.backgroundTask = .invalid
      print("⏳ iOS cerró la ventana de 30 segundos. App congelada.")
    }
    print("✅ Ventana de 30 segundos iniciada. MQTT sigue vivo.")
  }
  ...
  override func applicationWillEnterForeground(_ application: UIApplication) {
    ...
    if backgroundTask != .invalid {
      ...
      print("🔄 Usuario volvió. Tarea en segundo plano cancelada.")
    }
  }
}